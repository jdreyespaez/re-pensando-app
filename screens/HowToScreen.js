        ...
        <View style={styles.container}>
          ...
          <View style={styles.textContainer}>
            <Text style={styles.text}>
              1. Selecciona de las categorías que tenemos, el tipo de producto o
              material que deseas registrar.{"\n"}
              {"\n"}
              2. La aplicación te dará las pautas para clasificar y disponer
              correctamente tus residuos para que{" "}
              <Text style={{ textDecorationLine: "underline" }}>
                no sean conviertan en basura
              </Text>
              . {"\n"}
              {"\n"}
              3. Si registras tus residuos, la aplicación realizará semanalmente
              un gráfico estadístico de estos, donde podrás identificar cuales
              produces en mayor y menor medida. {"\n"}
            </Text>
            ...
            <Text style={styles.text}>
              4. Si registras tu basura mínimo tres días a la semana se
              habilitará una sección de la historia gráfica{" "}
